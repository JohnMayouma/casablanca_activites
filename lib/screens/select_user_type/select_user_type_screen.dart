...
class _SelectUserTypeScreenState extends State<SelectUserTypeScreen> {
  ...
  Widget _buildChoiceCard(String label, String imagePath, String value,
      {double borderRadius = 22, double imageHeight = 160}) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: isSelected ? Colors.red : Colors.grey.shade300, width: 2.2),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _buildChoiceCard('Visiteurs & Touristes',
                        'assets/images/touristes_velo.jpeg', 'user',
                        borderRadius: 22, imageHeight: 155),
                    _buildChoiceCard('Partenaires',
                        'assets/images/jazzablanca.jpg', 'partner',
                        borderRadius: 22, imageHeight: 180),
